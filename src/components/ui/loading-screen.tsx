...
export function LoadingScreen({ visible, variant, title, message, footer }: LoadingScreenProps) {
  const titleId = useId();
  ...
  return (
    ...
    >
      <div className="mx-4 flex w-full max-w-sm flex-col items-center gap-4 rounded-2xl border border-[rgba(237,241,241,0.12)] bg-[rgba(10,14,14,0.96)] p-6 text-center shadow-2xl">
